...
void __test__fncall(CuTest* tc) {
    ...
    static enum onk_lexicon_t check_list[][16] = {
        {ONK_WORD_TOKEN, Apply, 0},
        {ONK_WORD_TOKEN, Apply, 0},
        {ONK_WORD_TOKEN, Apply, Apply, 0},

        {ONK_WORD_TOKEN, ONK_INTEGER_TOKEN, ONK_INTEGER_TOKEN, Apply, 0},
        {ONK_WORD_TOKEN, ONK_INTEGER_TOKEN, ONK_INTEGER_TOKEN, ONK_INTEGER_TOKEN, ONK_MUL_TOKEN, ONK_ADD_TOKEN, ONK_INTEGER_TOKEN, Apply, 0},
        {ONK_WORD_TOKEN, ONK_INTEGER_TOKEN, ONK_INTEGER_TOKEN, onk_tuple_group_token, Apply, 0},
        {ONK_WORD_TOKEN, ONK_INTEGER_TOKEN, ONK_INTEGER_TOKEN, onk_tuple_group_token, ONK_INTEGER_TOKEN, ONK_INTEGER_TOKEN, Apply, 0},
        {ONK_WORD_TOKEN, ONK_WORD_TOKEN, ONK_INTEGER_TOKEN, ONK_INTEGER_TOKEN, Apply, ONK_INTEGER_TOKEN, ONK_INTEGER_TOKEN, Apply, 0},
        {ONK_WORD_TOKEN, ONK_INTEGER_TOKEN, ONK_INTEGER_TOKEN, ONK_INTEGER_TOKEN, ONK_WORD_TOKEN, ONK_INTEGER_TOKEN, ONK_INTEGER_TOKEN, Apply, 0},
        {ONK_WORD_TOKEN, ONK_WORD_TOKEN, ONK_INTEGER_TOKEN, ONK_INTEGER_TOKEN, ONK_INTEGER_TOKEN, ONK_MUL_TOKEN, Apply, ONK_INTEGER_TOKEN, ONK_INTEGER_TOKEN, Apply, 0},        
        0
    };
