...
enum onk_lexicon_t {
    ...
    PH_ONK_MARKER_UPGRADE_OP_START,

    /* = */
    ONK_EQUAL_TOKEN,
    PH_ONK_MARKER_ASN_END,
    ...
    PH_ONK_MARKER_KEYWORD_BLOCK_END,
