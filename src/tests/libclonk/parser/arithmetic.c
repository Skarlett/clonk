...
void __test__simple_order_precedence(CuTest* tc) {
    ...
    static enum onk_lexicon_t check_list[][16] = {
        ...
        {ONK_WORD_TOKEN, ONK_INTEGER_TOKEN, ONK_EQUAL_TOKEN, 0},
        {ONK_WORD_TOKEN, ONK_WORD_TOKEN, ONK_WORD_TOKEN, ONK_EQUAL_TOKEN, ONK_EQUAL_TOKEN, 0},
        {ONK_WORD_TOKEN, ONK_WORD_TOKEN, ONK_WORD_TOKEN, ONK_EQUAL_TOKEN, ONK_EQUAL_TOKEN, 0},
        {ONK_WORD_TOKEN, ONK_WORD_TOKEN, ONK_INTEGER_TOKEN, ONK_WORD_TOKEN, ONK_MUL_TOKEN, ONK_EQUAL_TOKEN, ONK_EQUAL_TOKEN, 0},
        {ONK_WORD_TOKEN, ONK_WORD_TOKEN, ONK_INTEGER_TOKEN, ONK_MUL_TOKEN, ONK_WORD_TOKEN, ONK_EQUAL_TOKEN, ONK_EQUAL_TOKEN, 0},
        {ONK_WORD_TOKEN, ONK_WORD_TOKEN, ONK_DOT_TOKEN, ONK_WORD_TOKEN, ONK_DOT_TOKEN, ONK_WORD_TOKEN, ONK_WORD_TOKEN, ONK_DOT_TOKEN, ONK_INTEGER_TOKEN, ONK_MUL_TOKEN, ONK_EQUAL_TOKEN,  0},
        0
    };
